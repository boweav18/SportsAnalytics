...
y1 = team %>%
  arrange(wake_calYear,wake_opponent,wake_game_number) %>%
  mutate(wake_game_number = as.character(wake_game_number)) %>%
  group_by(wake_calYear) %>%
  mutate(gameNumbers = paste(wake_game_number,collapse = ', ')) %>%
  mutate(opponents = paste(wake_opponent, collapse = ', '))

y1 = y1 %>%
  group_by(wake_calYear,opponents,gameNumbers) %>%
...
team_seasFilterRowInput<-function (inputID1,inputID2,inputID3) 
{
  fluidRow(
    column(3, selectInput(inputID1, "Choose the Variable to Filter:",
                          colnames(y1[,7:ncol(y1)]))),# only the numeric columns without pre-existing filters
    column(3, selectInput(inputID2, 'Relationship', c("Less Than", "Equal To", "Greater Than"))),
    column(3, numericInput(inputID3,"Value",0))
  )
}
...
ui = fluidPage(
  ...
  selectInput("v1", "Choose Offense or Defense:",
              c("Offense (Individual Game)" = "off_ind", "Offense (Individual Season)" = "off_seas",
                "Defense (Individual Season)" = "def_ind",
                "Team (Game)" = "team", "Team (Season)" = "team_seas")),
  ...
  conditionalPanel(
    condition = "input.v1 == 'team' | input.v1 == 'team_seas'",
    htmlOutput('text')
  ),
  conditionalPanel(
    condition = "input.v1 == 'team' | input.v1 == 'team_seas'",
  ...
  ## TEAM Season ADDITIONAL FILTERS ##
  conditionalPanel(
    condition = "input.v1 == 'team_seas' & input.num_add > 0",
    team_seasFilterRowInput("y1_add1","y1_eq_1","y1_rhs_1"),
    conditionalPanel(
      condition = "input.v1 == 'team_seas' & input.num_add > 1",
      team_seasFilterRowInput("y1_add2","y1_eq_2","y1_rhs_2")
    ),
    conditionalPanel(
      condition = "input.v1 == 'team_seas' & input.num_add > 2",
      team_seasFilterRowInput("y1_add3","y1_eq_3","y1_rhs_3")
    ),
    conditionalPanel(
      condition = "input.v1 == 'team_seas' & input.num_add > 3",
      team_seasFilterRowInput("y1_add4","y1_eq_4","y1_rhs_4")
    ),
    conditionalPanel(
      condition = "input.v1 == 'team_seas' & input.num_add > 4",
      team_seasFilterRowInput("y1_add5","y1_eq_5","y1_rhs_5")
    ),
    conditionalPanel(
      condition = "input.v1 == 'team_seas' & input.num_add > 5",
      team_seasFilterRowInput("y1_add6","y1_eq_6","y1_rhs_6")
    ),
    conditionalPanel(
      condition = "input.v1 == 'team_seas' & input.num_add > 6",
      team_seasFilterRowInput("y1_add7","y1_eq_7","y1_rhs_7")
    )
  ...
  conditionalPanel(
    condition = "input.v1 == 'off_ind' | input.v1 == 'def_ind'",
  ...
  conditionalPanel(
    condition = "input.v1 == 'team' | input.v1 == 'team_seas'", selectInput("cons1", "Choose Year or Games:",
              c("Year",
                "Game"))),
  
  ##Number of consecutive ____
  conditionalPanel(
    condition = "input.v1 == 'team' | input.v1 == 'team_seas'", selectInput("cons2", "n:", 
...
server = function(input, output, session) {
  ...
  datasetInput = reactive({
    ...
    ## IF TEAM Season ##
      ...
      filterRows = 1:nrow(y1)
      ## Make "Additional" Filters by Making Changes to Master ##
      if(input$num_add == 1){
        adds = c(input$y1_add1)
        eqs = c(input$y1_eq_1)
        rhss = c(input$y1_rhs_1)
        filterRows = addFilter(y1,1,adds,eqs,rhss)
      }
      else if(input$num_add == 2){
        adds = c(input$y1_add1,input$y1_add2)
        eqs = c(input$y1_eq_1,input$y1_eq_2)
        rhss = c(input$y1_rhs_1,input$y1_rhs_2)
        filterRows = addFilter(y1,2,adds,eqs,rhss)
      }
      else if(input$num_add == 3){
        adds = c(input$y1_add1,input$y1_add2,input$y1_add3)
        eqs = c(input$y1_eq_1,input$y1_eq_2,input$y1_eq_3)
        rhss = c(input$y1_rhs_1,input$y1_rhs_2,input$y1_rhs_3)
        filterRows = addFilter(y1,3,adds,eqs,rhss)
      }
      else if(input$num_add == 4){
        adds = c(input$y1_add1,input$y1_add2,input$y1_add3,input$y1_add4)
        eqs = c(input$y1_eq_1,input$y1_eq_2,input$y1_eq_3,input$y1_eq_4)
        rhss = c(input$y1_rhs_1,input$y1_rhs_2,input$y1_rhs_3,input$y1_rhs_4)
        filterRows = addFilter(y1,4,adds,eqs,rhss)
      }
      else if(input$num_add == 5){
        adds = c(input$y1_add1,input$y1_add2,input$y1_add3,input$y1_add4,input$y1_add5)
        eqs = c(input$y1_eq_1,input$y1_eq_2,input$y1_eq_3,input$y1_eq_4,input$y1_eq_5)
        rhss = c(input$y1_rhs_1,input$y1_rhs_2,input$y1_rhs_3,input$y1_rhs_4,input$y1_rhs_5)
        filterRows = addFilter(y1,5,adds,eqs,rhss)
      }
      else if(input$num_add == 6){
        adds = c(input$y1_add1,input$y1_add2,input$y1_add3,input$y1_add4,input$y1_add5,input$y1_add6)
        eqs = c(input$y1_eq_1,input$y1_eq_2,input$y1_eq_3,input$y1_eq_4,input$y1_eq_5,input$y1_eq_6)
        rhss = c(input$y1_rhs_1,input$y1_rhs_2,input$y1_rhs_3,input$y1_rhs_4,input$y1_rhs_5,input$y1_rhs_6)
        filterRows = addFilter(y1,6,adds,eqs,rhss)
      }
      else if(input$num_add == 7){
        adds = c(input$y1_add1,input$y1_add2,input$y1_add3,input$y1_add4,input$y1_add5,input$y1_add6,input$y1_add7)
        eqs = c(input$y1_eq_1,input$y1_eq_2,input$y1_eq_3,input$y1_eq_4,input$y1_eq_5,input$y1_eq_6,input$y1_eq_7)
        rhss = c(input$y1_rhs_1,input$y1_rhs_2,input$y1_rhs_3,input$y1_rhs_4,input$y1_rhs_5,input$y1_rhs_6,input$y1_rhs_7)
        filterRows = addFilter(y1,7,adds,eqs,rhss)
      }

      # identify which rows to keep based on CALENDAR YEAR
      rows = intersect(rows,which(y1$wake_calYear %in% cal_yr_list))
      rows = intersect(rows,filterRows)

      #Consecutive Years
      if(input$cons1 == 'Year'){
        split <- split(y1$wake_calYear[rows], cumsum(c(1, diff(y1$wake_calYear[rows]) != 1)))
        ...
        rows = intersect(rows,which(y1$wake_calYear %in% maxlisty))
        }
          ...
          rows = intersect(rows,which(y1$wake_calYear %in% specific1y))
        }
          ...
          rows = intersect(rows,which(y1$wake_calYear %in% specific2y))
          ...
          rows = intersect(rows,which(y1$wake_calYear %in% specific3y))
          ...
          rows = intersect(rows,which(y1$wake_calYear %in% specific4y))
          ...
          rows = intersect(rows,which(y1$wake_calYear %in% specific5y))
          ...
          rows = intersect(rows,which(y1$wake_calYear %in% specific6y))
          ...
          rows = intersect(rows,which(y1$wake_calYear %in% specific7y))
          ...
          rows = intersect(rows,which(y1$wake_calYear %in% specific8y))
          ...
          rows = intersect(rows,which(y1$wake_calYear %in% specific9y))
